...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkAnswer(boolean userPressedTrue) {
        ...
        if (mAnsweredQuestionCount == mQuestionBank.length) {
            String displayText = String.format("Percent correct = %.2f .", (float) 1.0 * mCorrectAnswerCount / mAnsweredQuestionCount);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putInt(KEY_CORRECT_COUNT, mCorrectAnswerCount);
        savedInstanceState.putInt(KEY_ANSWERED_COUNT, mAnsweredQuestionCount);
    }
}
